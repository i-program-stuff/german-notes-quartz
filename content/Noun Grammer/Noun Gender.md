In German, unlike English, nouns have grammatical gender instead of just biological gender.

| Gender    | Examples              | English               |
| --------- | --------------------- | --------------------- |
| Masculine | der Mann, der Tisch   | the man, the table    |
| Feminine  | die Frau, die Tür     | the woman, the door   |
| Neuter    | das Kind, das Fenster | the child, the window |
...
| -ich   | der Teppich, der Teich           | carpet, pond          |
| -ist   | der Komponist, der Egoist        | composer, egoist      |

**Groups:**

| Category               | Examples (German)      | English Translation |
| ---------------------- | ---------------------- | ------------------- |
| Male persons           | der Vater, der Sohn    | father, son         |
| Names of days & months | der Montag, der August | Monday, August      |
...
Beer is an exception to the Alcoholic drinks rule, it is *das Bier* in German.
...
90% of Words that end in "e" are Feminine. Exceptions exist like *der Name*.

| Suffix  | Examples (German)                  | English Translation                 |
| ------- | ---------------------------------- | ----------------------------------- |
...
| Names of motorbikes & ships | die BMW, die Titanic    | BMW, Titanic        |
| Names of trees & flowers    | die Eiche, die Rose     | oak, rose           |

*das Mädchen* which means "girl" is a notable exception.
...
*die Firma* (company) is a notable exception.
